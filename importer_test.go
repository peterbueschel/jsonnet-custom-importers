...
func TestMultiImporter_InFileConfigs(t *testing.T) {
	wantGraphLines := []string{
		...
		``,
		`	"testdata/inFileConfigs/importGraph.jsonnet" [ shape="invhouse",  weight=0 ];`,
		``,
		...
		``,
		`	"testdata/inFileConfigs/caller.jsonnet" [ shape="invhouse",  weight=0 ];`,
		``,
		...
		``,
		`	"libs/host.libsonnet" [ shape="house",  weight=0 ];`,
		``,
